...
export default class AddNew extends React.Component {
    ...
    updateanswer = (evt) => {
        this.setState(
            ...
            () => {
                ...
                let submitValid =
                    this.state.bodySystemsValid && this.state.textValid && modalityValid;
    ...
    updateFormField = (evt) => {
        this.setState(
            ...
            () => {
                let textValid =
                    this.state.signsSymptomsTitle.length >= 1 &&
                        this.state.patientID.length >= 1 &&
                        this.state.gender.length >= 1 &&
                        this.state.dob.length >= 1 &&
                        this.state.clinicalHistory.length >= 1 &&
                        this.state.images.length >= 1 &&
                        this.state.scientificReferences.length >= 1 &&
                        this.state.caseDiscussion.length >= 1 &&
                        this.state.radiologistId.length >= 1
                        ? true
                        : false;
                let submitValid =
                    this.state.bodySystemsValid && this.state.modalityValid && textValid;
                this.setState({
                    textValid: textValid,
                    submitDisabled: !submitValid,
                });
    ...
    updateitems = (evt) => {
        ...
        this.setState(
            ...
            () => {
                let bodySystemsValid =
                    this.state.bodySystems.length >= 1 ? true : false;
                let submitValid =
                    this.state.textValid && this.state.modalityValid && bodySystemsValid;
                this.setState({
            ...
            <React.Fragment>
                ...
                <div>
                    <label className="form-label">
                        Patient's date of birth (please enter in YYYY-MM-DD format):
                    </label>
                    <input
                        type="text"
                        name="dob"
                ...
                <div>
                    <label className="form-label">
                        Please place patient's diagnostic images using photobucket URL here:
                    </label>
                    <input
                        type="text"
                        name="images"
                    ...
                    <ul>
                        <p>
                            <input
                                ...
                                checked={this.state.modality === "X-ray"}
                            />
                            <label>&nbsp;X-ray</label>
                        </p>
                        ...
                        <p>
                            <input
                                ...
                                onChange={this.updateanswer}
                                checked={this.state.modality === "Computed Tomography"}
                            />
                        ...
                        <p>
                            <input
                                ...
                                value="Ultrasound"
                                onChange={this.updateanswer}
                                checked={this.state.modality === "Ultrasound"}
                            />
                        ...
                        <p>
                            <input
                                ...
                                value="MRI"
                                onChange={this.updateanswer}
                                checked={this.state.modality === "MRI"}
                            />
                            <label>&nbsp;MRI</label>
                        </p>
                    </ul>
                ...
                <div>
                    <label className="form-label">
                        Please enter your Radiologist ID:
                    </label>
                    <input
                        type="text"
                        name="radiologistId"
                    ...
                    <div className="form-label checkbox">
                        <p>
                            <input
                                ...
                                checked={this.state.bodySystems.includes("Cardiovascular")}
                            />
                        ...
                        <p>
                            <input
                                ...
                                onChange={this.updateitems}
                                checked={this.state.bodySystems.includes("Gastrointestinal")}
                            />
                        ...
                        <p>
                            <input
                                ...
                                value="Endocrine"
                                onChange={this.updateitems}
                                checked={this.state.bodySystems.includes("Endocrine")}
                            />
                        ...
                        <p>
                            <input
                                ...
                                value="Exocrine"
                                onChange={this.updateitems}
                                checked={this.state.bodySystems.includes("Exocrine")}
                            />
                        ...
                        <p>
                            <input
                                ...
                                value="Lymphatic"
                                onChange={this.updateitems}
                                checked={this.state.bodySystems.includes("Lymphatic")}
                            />
                        ...
                        <p>
                            <input
                                ...
                                value="Muscular"
                                onChange={this.updateitems}
                                checked={this.state.bodySystems.includes("Muscular")}
                            />
                        ...
                        <p>
                            <input
                                ...
                                value="Nervous"
                                onChange={this.updateitems}
                                checked={this.state.bodySystems.includes("Nervous")}
                            />
                            <label>&nbsp;Nervous</label>
                        </p>
                        ...
                        <p>
                            <input
                                ...
                                value="Renal"
                                onChange={this.updateitems}
                                checked={this.state.bodySystems.includes("Renal")}
                            />
                            <label>&nbsp;Renal</label>
                        </p>
                        ...
                        <p>
                            <input
                                ...
                                value="Reproductive"
                                onChange={this.updateitems}
                                checked={this.state.bodySystems.includes("Reproductive")}
                            />
                        ...
                        <p>
                            <input
                                ...
                                value="Respiratory"
                                onChange={this.updateitems}
                                checked={this.state.bodySystems.includes("Respiratory")}
                            />
                        ...
                        <p>
                            <input
                                ...
                                value="Skeletal"
                                onChange={this.updateitems}
                                checked={this.state.bodySystems.includes("Skeletal")}
                            />
