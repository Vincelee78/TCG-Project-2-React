...
export default class Report extends React.Component {
    ...
    renderTooltip = () => <Tooltip>Favourite this report</Tooltip>;
    ...
    renderContent = () => {
        return this.state.data.map((reportData) => {
            return (
                <React.Fragment>
                    <div class="p-5 bg-dark text-white rounded-3">
                        ...
                        <h3 style={{ color: "wheat" }}>References: </h3>
                        <p> {reportData.reportReferences}</p>
                        <h3 style={{ color: "wheat" }}>
                            Tags (Published Date, Scientific Referencing):
                        </h3>
                        {reportData.reportTags.map((i) => (
                            <h6>
                                <li className="reportTags">{i}</li>
                            </h6>
                        ))}

                        <div className="buttonsReports">
                            <button
                                className="deleteReport btn btn-danger my-3"
                                onClick={() => {
            ...
            <React.Fragment>
                <div class="container-lg">
                    <div class="p-5 mb-4 bg-dark text-white rounded-3">
                        ...
                        <p class="lead">
                            Reports are a collaborative effort to provide a single canonical
                            page on all topics relevant to the practice of radiology. As such,
                            reports are written by contributing members over a period of time.
                            A group of editors oversee accuracy, consulting with expert
                            advisers, and constantly reviewing additions.
                        </p>
                    </div>
                    {this.renderContent()}
                </div>
